...
type ListResult =
  ...
  | { state: "ready"; epics: Epic[] };

const emptyInput: EpicInput = {
  projeto_id: "",
  titulo: "",
  descricao: "",
  objetivo: "",
      ...
      .catch((error) => {
        ...
        setResult({
          ...
          message:
            ...
            && error.status === 401
              ? "É necessário entrar para acessar os épicos."
              : "Não foi possível carregar os épicos.",
        });
      });
                    ...
                    (epic) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() =>
                            navigate(
                              `/projects/${projetoId}/epics/${epic.id}`,
                            )
                          }
                        >
                          Ver épico
      ...
      <div className="projects-heading">
        <div>
          ...
          <p>
            ...
            Os demais campos do guia
            são exigidos para concluir.
          </p>
        </div>
      </div>
          ...
          try {
            ...
            setMessage(
              ...
              && error.status === 404
                ...
                : "Não foi possível criar o épico. Tente novamente.",
            );
          } finally {
            submitting.current =
              false;
...
export function EpicDetail({
        ...
        setResult({
          ...
          message:
            ...
            && error.status === 404
              ...
              : "Não foi possível carregar o épico.",
        });
      });
  ...
  const epicoArquivado =
    epic.status === "arquivado";
                            ...
                            try {
                              ...
                              setCompletionMessage(
                                campos
                                  ...
                                  : "Não foi possível concluir o épico.",
                              );
                            } finally {
                              setCompleting(
                                false,
