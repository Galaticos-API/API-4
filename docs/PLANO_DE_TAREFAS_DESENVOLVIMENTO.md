...
| PRE-04 | Must | Em revisão | Criar fundação de testes | Suites de backend, frontend e IA executadas pela CI; o runner do backend descobre testes recursivamente (46 testes atuais). Aguarda revisão independente para encerrar | — | M | QA, CI |
